...
Security/session requirements in UI:
- Browser must allow session cookies
- Session timeout policy: 15 minutes inactivity
- Default admin credentials require mandatory password reset before dashboard access
